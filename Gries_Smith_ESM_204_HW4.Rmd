...
ggplot(data = damages_scale, aes(x = warming, y = damages)) +
  geom_point() +
  geom_smooth(aes(x = warming_range, y = damage_predict)) +
...
#divide difference by 35 billion to get the effect per ton
pulse_ton <- 35000000000
...
*Note: the difference in damages between the two scenarios is relatively small and the "pulse scenario" (red line) is only marginally higher than the "baseline" scenario (yellow line)*

#### **Figure 3 and 4: Difference in Absolute and Per Ton Damages Over Time Between Scenarios**
...
#### **Figure 5: Discount Rate Impacts on SCC**
...
#### **Figure 6: The NPV of future damages between 2021 and 2100 at year 2021 discounted with respect to various discount rates. The coral point shows the discount rate and SCC associated with recommendations made by The National Academies of Sciences, Engineering, and Medicine**
