...
warming_square <- damages$warming^2

# now we regress, force the itnercept to 0

damage_model <- lm(damages ~ 0 + warming + warming_square, data = damages)
...
ggplot(data = damages, aes(x = warming, y = damages)) +
  ...
  labs(x = 'Warming (Degrees Celsius)', y = 'Damages ($)')

#Looks good enough to me, may need to scale the damage values 
